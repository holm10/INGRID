...
def set_gridue_coords(ingridobj,rm,zm,nx,ny,ixpt1,ixpt2,iysptrx):
...
i=ingrid.Ingrid()
# Set path to eqdsk-file
i.settings['eqdsk'] = '/Users/holma2/Dropbox (Aalto)/UEDGE/INGRID/INGRID/INGRID/seq#1/eqdsk'
# Ensure LSN
i.settings['grid_settings']['num_xpt'] = 1
# Set intial guess to be below magnetic axis
i.settings['grid_settings']['rxpt'] = 0
i.settings['grid_settings']['zxpt'] = -1

i.StartSetup()
i.SetTopology('LSN')
set_gridue_coords(i,*e.grid('/Users/holma2/Dropbox (Aalto)/UEDGE/E2D-EIR_integration/exporte2dgrid/aholm_mar1719_11'))
i.ExportGridue()

# Create a test case to display the UEDGE solution
from uedge import *
# import uedge.contrib.holm10.plot as p # Personal plotting routines
